...
try{const entry=resolve(temp,'entry.mjs');await writeFile(entry,['button','icon','badge','dialog','segmented-control','search-input'].map(x=>`import ${JSON.stringify(resolve(dir,'packages/elements/dist/define/'+x+'.js'))};`).join('\n'));
