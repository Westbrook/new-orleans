...
const CACHE = PREFIX + "nola-044687027905";
const FILES = ["./","./app.js","./assets/icon.svg","./assets/jackson-square.jpg","./components.css","./data/map.json","./data/original-list.txt","./data/venues.json","./guide-utils.js","./index.html","./itinerary.js","./manifest.webmanifest","./styles.css","./vendor/EN-REVE-LICENSE","./vendor/LIT-LICENSE","./vendor/NOTICE.txt","./vendor/SIGNAL-POLYFILL-LICENSE","./vendor/SIGNAL-UTILS-LICENSE","./vendor/en-reve.js","./vendor/tokens.css","./weather.js","./offline-manifest.json"];
